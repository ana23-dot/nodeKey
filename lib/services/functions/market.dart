...
Future<List<double>> getMarketChart(WalletProvider walletProvider,
  ...
  if (response.statusCode == 200) {
    ...
    for (var i in prices) {
      final priceValue = double.tryParse(i[1].toString());
      if (priceValue != null) {
